...
export declare type OnPacketCallback = (packet: any) => void
export declare type OnErrorCallback = (error: Error) => void
export declare type PacketCallback = (error?: Error, packet?: any) => any
...
export declare class MqttClient extends events.EventEmitter {
     ...
     * @api public
     */
    public handleMessage(packet: any, callback: PacketCallback): void
